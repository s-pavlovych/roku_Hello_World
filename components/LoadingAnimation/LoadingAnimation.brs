...
function _initVars()
    ...
    m.circleTwo = m.top.FindNode("circleTwo")
    m.circleThree = m.top.FindNode("circleThree")
...
sub valuesToDefault()
    ...
    m.circleOne.blendColor = "0xFF0000FF"
    m.circleTwo.blendColor = "0xFF0000FF"
    m.circleThree.blendColor = "0xFF0000FF"
